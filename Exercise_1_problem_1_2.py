...
def create_point_geom(x_coord, y_coord):
  ...
  -------
  <float>
  return Points x coordinate,y coordinate
  """
...
def create_line_geom(points):
  """"
  Function for taking a list of Shapely Point objects as parameter

  Parameters
  ----------
  points;<numerical>
   The number of ponits
...
def create_poly_geom(coords):
  """"
  Function to create and return a Polygon object based on these coordinates.
...
def get_centroid(geom):
  """"
  Function to take any kind of Shapely's geometric -object as an input, and return a centroid of that geometry.

  Parameters
  ----------
  geom;<numerical>
   the input is a Shapely Point, LineString or Polygon geometry
